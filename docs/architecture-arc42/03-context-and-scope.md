...
**Out of scope:** Hosting Ollama or llama.cpp binaries inside the repo (detection/paths are configurable); full ML training stack (only orchestration + script path).
